...
| AtvBotaoAcaoExterna Component | deve executar a função comando ao clicar no botão | ✅ | ✅ | Sem erros |
...
| AtvBotaoAcaoInterna Component | deve exibir um alerta com o texto "Fui clicado!" ao clicar no botão | ✅ | ✅ | Sem erros |
...
| AtvParagrafo | deve renderizar o conteúdo como P com tamanho de fonte 16px | ✅ | ❌ | AssertionError: expected '' to deeply equal '16px' |
