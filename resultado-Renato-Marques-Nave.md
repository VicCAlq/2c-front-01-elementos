...
| AtvBotaoAcaoInterna Component | deve exibir um alerta com o texto "Fui clicado!" ao clicar no botão | ✅ | ❌ | AssertionError: expected "bound " to be called with arguments: [ 'Fui clicado!' ][90m |
