...
export default function AtvDivisoria({ largura }) {
    ...
    return (
        <div style={style.container}>
            <p> Teste</p>
            <div style={style.esquerda}>meu plano maligno esta se concretizandoooooo</div>
            <div style={style.direita}>plano maligno finalizadooooooooooooo (se voce for japones leia a parte esquerda primeiro)</div>
        </div>
    );
}
